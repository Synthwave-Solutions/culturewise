    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        drawer: InkWell(
          ...
          onTap: () async {
            logFirebaseEvent('CHAT_AI_SCREEN_Drawer_zjbwhv0i_ON_TAP');
                ...
                children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'CHAT_AI_SCREEN_PAGE_Icon_ihgmh7sa_ON_TAP');
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'CHAT_AI_SCREEN_PAGE_Row_r811bczx_ON_TAP');
                            logFirebaseEvent('Row_navigate_to');
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'CHAT_AI_SCREEN_PAGE_Row_u5ouwtao_ON_TAP');
                            logFirebaseEvent('Row_navigate_to');
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'CHAT_AI_SCREEN_PAGE_Row_fg35bor7_ON_TAP');
                            logFirebaseEvent('Row_navigate_to');
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'z11t8son' /* Skill Development Plan */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .titleSmall
                                      .override(
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'CHAT_AI_SCREEN_PAGE_Row_lw7h82nx_ON_TAP');
                            logFirebaseEvent('Row_navigate_to');
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'CHAT_AI_SCREEN_PAGE_Row_yoq6w1lp_ON_TAP');
                            logFirebaseEvent('Row_navigate_to');
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'CHAT_AI_SCREEN_PAGE_Row_lw7jbojx_ON_TAP');
                            logFirebaseEvent('Row_navigate_to');
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'CHAT_AI_SCREEN_PAGE_contentView_1_ON_TAP');
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'CHAT_AI_SCREEN_lightDark_small_ON_TAP');
          ...
          title: Row(
            ...
            children: [
              FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('CHAT_AI_SCREEN_menu_sharp_ICN_ON_TAP');
