...
import 'event_list_page_model.dart';
export 'event_list_page_model.dart';

class EventListPageWidget extends StatefulWidget {
  const EventListPageWidget({super.key});

  @override
  State<EventListPageWidget> createState() => _EventListPageWidgetState();
}

class _EventListPageWidgetState extends State<EventListPageWidget>
    with TickerProviderStateMixin {
  late EventListPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EventListPageModel());
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        drawer: InkWell(
          ...
          onTap: () async {
            logFirebaseEvent('EVENT_LIST_Drawer_o3w8lrsd_ON_TAP');
                ...
                children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'EVENT_LIST_Icon_e9oa92he_ON_TAP');
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'EVENT_LIST_PAGE_PAGE_Row_cf190x1n_ON_TAP');
                            logFirebaseEvent('Row_navigate_to');
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'EVENT_LIST_PAGE_PAGE_Row_o1lg94ym_ON_TAP');
                            logFirebaseEvent('Row_navigate_to');
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'EVENT_LIST_PAGE_PAGE_Row_biei33fr_ON_TAP');
                            logFirebaseEvent('Row_navigate_to');
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'asnif8rn' /* Skill Development Plan */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .titleSmall
                                      .override(
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'EVENT_LIST_PAGE_PAGE_Row_yrhwd9na_ON_TAP');
                            logFirebaseEvent('Row_navigate_to');
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'EVENT_LIST_PAGE_PAGE_Row_zs8tsrqj_ON_TAP');
                            logFirebaseEvent('Row_navigate_to');
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'EVENT_LIST_PAGE_PAGE_Row_oif9cvj8_ON_TAP');
                            logFirebaseEvent('Row_navigate_to');
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        logFirebaseEvent('EVENT_LIST_contentView_1_ON_TAP');
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'EVENT_LIST_lightDark_small_ON_TAP');
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('EVENT_LIST_menu_sharp_ICN_ON_TAP');
                                    ...
                                    Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'EVENT_LIST_Column_5bb9zvr4_ON_TAP');
                                            logFirebaseEvent(
                                                'Column_navigate_to');
                                    ...
                                    Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'EVENT_LIST_Column_5e1oq6l3_ON_TAP');
                                            logFirebaseEvent(
                                                'Column_navigate_to');
