...
class _CoursePageWidgetState extends State<CoursePageWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'coursePage'});
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: InkWell(
          ...
          onTap: () async {
            logFirebaseEvent('COURSE_PAGE_PAGE_Icon_bm87p88b_ON_TAP');
