...
class YearWrapupPageWidget extends StatefulWidget {
  const YearWrapupPageWidget({super.key});

  @override
  State<YearWrapupPageWidget> createState() => _YearWrapupPageWidgetState();
}

class _YearWrapupPageWidgetState extends State<YearWrapupPageWidget>
    with TickerProviderStateMixin {
  late YearWrapupPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => YearWrapupPageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'yearWrapupPage'});
    setupAnimations(
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        drawer: InkWell(
          ...
          onTap: () async {
            logFirebaseEvent('YEAR_WRAPUP_Drawer_e1dos5t4_ON_TAP');
                ...
                children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'YEAR_WRAPUP_Icon_4pn45njs_ON_TAP');
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            logFirebaseEvent('YEAR_WRAPUP_Row_86r69een_ON_TAP');
                            logFirebaseEvent('Row_navigate_to');
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            logFirebaseEvent('YEAR_WRAPUP_Row_51mnfrgw_ON_TAP');
                            logFirebaseEvent('Row_navigate_to');
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'f7aa47us' /* Skill Development Plan */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .titleSmall
                                    .override(
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            logFirebaseEvent('YEAR_WRAPUP_Row_txjo7yin_ON_TAP');
                            logFirebaseEvent('Row_navigate_to');
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            logFirebaseEvent('YEAR_WRAPUP_Row_m5s67b18_ON_TAP');
                            logFirebaseEvent('Row_navigate_to');
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            logFirebaseEvent('YEAR_WRAPUP_Row_cg7p6vpu_ON_TAP');
                            logFirebaseEvent('Row_navigate_to');
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        logFirebaseEvent('YEAR_WRAPUP_contentView_1_ON_TAP');
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'YEAR_WRAPUP_lightDark_small_ON_TAP');
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('YEAR_WRAPUP_menu_sharp_ICN_ON_TAP');
